...
export class MutationRecord {
    constructor (data) {
        const settings = { // technically these should be on proto so hasOwnProperty will return false for non explicitly props
            type: null,
            target: null,
            addedNodes: [],
            removedNodes: [],
...
const intersectSetter = function (proto, propertyName, intersect) {
...
const intersectMethod = function (proto, methodName, intersect) {
...
function patchNotifyChange (window) {
    ...
    intersectSetter(elemProto, 'innerHTML', notify);
    intersectSetter(elemProto, 'outerHTML', notify);
    intersectMethod(elemProto, 'removeChild', notify);
    intersectMethod(elemProto, 'insertAdjacentHTML', notify);
    intersectMethod(elemProto, 'setAttribute', notify);
    intersectMethod(elemProto, 'removeAttribute', notify);
    intersectMethod(elemProto, 'removeAttributeNode', notify);
    intersectMethod(elemProto, 'removeAttributeNS', notify);
}
